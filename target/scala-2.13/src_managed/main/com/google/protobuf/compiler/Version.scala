...
final case class Version(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.google.protobuf.compiler.Version = {
    ...
    def companion = com.google.protobuf.compiler.Version
}

object Version extends scalapb.GeneratedMessageCompanion[com.google.protobuf.compiler.Version] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.google.protobuf.compiler.Version] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): com.google.protobuf.compiler.Version = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.google.protobuf.compiler.Version] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = com.google.protobuf.compiler.Version(
    major = _root_.scala.None,
    minor = _root_.scala.None,
    patch = _root_.scala.None,
    suffix = _root_.scala.None
  )
  implicit class VersionLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.google.protobuf.compiler.Version]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.google.protobuf.compiler.Version](_l) {
  ...
  ): _root_.com.google.protobuf.compiler.Version = _root_.com.google.protobuf.compiler.Version(
    major,
    minor,
    patch,
    suffix
