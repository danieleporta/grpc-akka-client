...
final case class HttpBody(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.google.api.HttpBody = {
      var __contentType = this.contentType
      var __data = this.data
      val __extensions = (_root_.scala.collection.immutable.Vector.newBuilder[com.google.protobuf.any.Any] ++= this.extensions)
      var _done__ = false
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 26 =>
            __extensions += _root_.scalapb.LiteParser.readMessage(_input__, com.google.protobuf.any.Any.defaultInstance)
    ...
    def companion = com.google.api.HttpBody
}
...
object HttpBody extends scalapb.GeneratedMessageCompanion[com.google.api.HttpBody] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): com.google.api.HttpBody = {
