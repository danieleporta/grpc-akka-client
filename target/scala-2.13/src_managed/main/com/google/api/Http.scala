...
final case class Http(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.google.api.Http = {
      val __rules = (_root_.scala.collection.immutable.Vector.newBuilder[com.google.api.HttpRule] ++= this.rules)
      ...
      while (!_done__) {
        ...
        _tag__ match {
          case 0 => _done__ = true
          case 10 =>
            __rules += _root_.scalapb.LiteParser.readMessage(_input__, com.google.api.HttpRule.defaultInstance)
          case 16 =>
    ...
    def companion = com.google.api.Http
}
...
object Http extends scalapb.GeneratedMessageCompanion[com.google.api.Http] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): com.google.api.Http = {
    _root_.scala.Predef.require(__fieldsMap.keys.forall(_.getContainingType() == javaDescriptor), "FieldDescriptor does not match message type.")
    val __fields = javaDescriptor.getFields
    com.google.api.Http(
      __fieldsMap.getOrElse(__fields.get(0), Nil).asInstanceOf[_root_.scala.Seq[com.google.api.HttpRule]],
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.google.api.Http] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.google.api.Http(
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scala.Seq[com.google.api.HttpRule]]).getOrElse(_root_.scala.Seq.empty),
